//
//  BLEManager.swift (originally DZBluetoothSerialHandler.swift)
//  BLE Embeded Sample
//
...
let SAMPLESERVICEUUID = "FFE0" //TODO: Replace with your device's service UUID
let SAMPLECHARACHTERISTICUUID = "FFE1" //TODO: Replace with your device's characteristic UUID

/// Global serial handler, don't forget to initialize it with init(delgate:)
var serial: BluetoothSerial!

// MARK: - Required delegate BluetoothSerialDelegate -
...
// MARK: - Optional BluetoothSerialDelegate -
...
{    
    ...
    var serviceUUID = CBUUID(string: SAMPLESERVICEUUID)
    
    /// UUID of the characteristic to look for.
    var characteristicUUID = CBUUID(string: SAMPLECHARACHTERISTICUUID)
    ...
    func startScan()
    {
        ...
        //If you have your specific UUID you can enter
