...
func showAlert(title: String, msg: String, btnTitle: String, btnHandler: @escaping alertAction, vc: UIViewController?)
{
    let controller = UIAlertController(title: title, message: msg, preferredStyle: UIAlertController.Style.alert)
    let okAction = UIAlertAction(title: btnTitle, style: UIAlertAction.Style.default, handler: btnHandler)
